...
local allowed = {
    uiScale = function(value) return type(value) == "number" and value >= 0.8 and value <= 1.4 end,
    reducedMotion = function(value) return type(value) == "boolean" end,
    flashLimit = function(value) return type(value) == "boolean" end,
    cameraShake = function(value) return type(value) == "boolean" end,
    highContrast = function(value) return type(value) == "boolean" end,
    layout = function(value) return type(value) == "string" and #value <= 64 end,
}
