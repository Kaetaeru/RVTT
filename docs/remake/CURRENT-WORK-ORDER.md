...
| 순서 | 상태 | 작업 | 완료 조건 |
|---:|---|---|---|
| 1 | `IN_PROGRESS` | Ruleset Policy Registry, Composition과 Frozen Snapshot Runtime | Architecture 계약, ADR-0081, 인덱스 연결, Policy 우선순위·버전·충돌·Snapshot 계약과 문서 검증 완료 |
| 2 | `QUEUED` | Encounter–Game Time Boundary 통합 계약 | `TemporalBoundaryOccurrence`, Campaign Time 반영, Scheduler Due 역방향 연결과 직접 상호 호출 금지 확정 |
